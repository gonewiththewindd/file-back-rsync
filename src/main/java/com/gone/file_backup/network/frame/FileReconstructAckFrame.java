...
public class FileReconstructAckFrame extends OperationBaseFrame {

    private String fid;
    private boolean retry;

    public FileReconstructAckFrame() {

    }

    public static FileReconstructAckFrame parse(ByteBuf buf) {
        ...
        FileReconstructAckFrame reconstructFrame = new FileReconstructAckFrame();
